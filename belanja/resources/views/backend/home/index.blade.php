            ...
            <div class="card-body p-0">
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 increase ps-0">
                  <div class="d-flex pe-3"><span class="me-2">Year:</span><span>2024<i class="fa fa-caret-down ms-2"></i></span></div>
            ...
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-grow-1">
                  ...
                  <p>The goal of this message is to welcome you to our app.</p><a class="btn btn-primary" href="list-products.html">Go Premium</a>
                </div>
        ...
        <div class="col-xl-2 col-xl-25 col-lg-4 col-md-4 col-sm-6">
          <div class="card mobile-app">
            <div class="card-body">
              <div class="app-design">
                <div class="d-flex">
                  <div class="flex-shrink-0 bg-light-primary me-2">
                    <svg>
                      <use href="https://admin.pixelstrap.net/crocs/assets/svg/icon-sprite.svg#mobile-app"></use>
                    </svg>
                  </div>
                  <div class="flex-grow-1">
                ...
                <ul>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Due Date</h6><span>25-10-2024</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Budget</h6><span>$36,000.00</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Client</h6><span>Joohee Lee</span></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div class="user-details customers">
                <ul>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/20.png" alt="user"></li>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/21.png" alt="user"></li>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/22.png" alt="user"></li>
                </ul>
                <button class="btn btn-secondary">Pending</button>
              </div>
            </div>
        ...
        <div class="col-xl-2 col-xl-25 col-lg-4 col-md-4 col-sm-6">
          <div class="card mobile-app">
            <div class="card-body banking-web">
              <div class="app-design">
                <div class="d-flex">
                  <div class="flex-shrink-0 bg-light-secondary me-2">
                    <svg>
                      <use href="https://admin.pixelstrap.net/crocs/assets/svg/icon-sprite.svg#banking-web"></use>
                    </svg>
                  </div>
                  <div class="flex-grow-1">
                ...
                <ul>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Due Date</h6><span>12-04-2024</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Budget</h6><span>$42,500.00</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Client</h6><span>Wonkyu Min</span></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div class="user-details customers">
                <ul>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/23.png" alt="user"></li>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/24.png" alt="user"></li>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/25.png" alt="user"></li>
                </ul>
                <button class="btn btn-success">Done</button>
              </div>
            </div>
        ...
        <div class="col-xl-2 col-lg-4 col-md-4 finance">
          <div class="card mobile-app">
            <div class="card-body finance-app">
              <div class="app-design">
                <div class="d-flex">
                  <div class="flex-shrink-0 bg-light-success me-2">
                    <svg>
                      <use href="https://admin.pixelstrap.net/crocs/assets/svg/icon-sprite.svg#finance-app"></use>
                    </svg>
                  </div>
                  <div class="flex-grow-1">
                ...
                <ul>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Due Date</h6><span>10-09-2024</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Budget</h6><span>$15,600.00</span></a></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="d-flex">
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"> <a href="product.html">
                            <h6>Client</h6><span>Yongjae Choi</span></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div class="user-details customers">
                <ul>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/26.png" alt="user"></li>
                  <li class="d-inline-block"><img src="../assets/images/dashboard-3/user/27.png" alt="user"></li>
                </ul>
                ...
                <table class="table display" id="upcoming-deadlines" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="progress">
                          <div class="progress-bar bg-secondary" role="progressbar" style="width: 20%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                ...
                <table class="table display" id="team-members" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex">
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/33.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                              <h6>David</h6></a></div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex">
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/34.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                              <h6>Nasuha</h6></a></div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex">
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/35.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                              <h6>Induan</h6></a></div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex">
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-3/user/36.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                              <h6>Wonkyu</h6></a></div>
                        </div>
                      </td>
