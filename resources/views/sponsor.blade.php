              ...
              <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('add-post-sponsor') }}">Add Sponsor</a></li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <!-- Container-fluid starts-->
                <div class="sponsorslider position-relative px-3 py-5 my-1">
                  <section class="ribbon sponsor-slider">
                    <div>
                      @if($posts->isEmpty())
                        <p style="color: black;">No posts available.</p>
                      @else
                        <div class="row">
                          <div class="col-12">
                            <div>
                              <div class="marquee">
                                <ul class="marquee__content">
                                  ...
                                  <li class="image-item" data-id="{{ $post->id }}">
          ...
          document.addEventListener('DOMContentLoaded', function() {
            ...
            removeButtons.forEach(button => {
              button.addEventListener('click', function() {
                ...
                const postId = imageItem.getAttribute('data-id'); // Ambil ID gambar
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    .then(response => response.json()) // Parse response ke format JSON
                    .then(data => {
                      if (data.success) {
                        // Jika berhasil, hapus gambar dari tampilan
                        imageItem.remove();
                        Swal.fire(
                          'Terhapus!',
                          'Post telah berhasil dihapus.',
                          'success'
                        );
                      } else {
                        Swal.fire(
