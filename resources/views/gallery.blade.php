                                            ...
                                            <div class="col-lg-3">
                                                <div class="card border-0 shadow-sm h-100">
                                                    <img class="card-img-top img-fluid rounded-top" 
                                                         src="{{ asset('storage/images/' . $gallery->image) }}" 
                                                         alt="{{ $gallery->title }}">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center gap-2 mb-2 text-muted">
                                                            <i class="fa fa-calendar-alt"></i>
                                                            <small>{{ \Carbon\Carbon::parse($gallery->publish_date)->format('d F Y') }}</small>
                                                        </div>
                                                        <h5 class="card-title text-primary">{{ $gallery->title }}</h5>
                                                        <p class="card-text text-secondary mb-3">{{ $gallery->description }}</p>
