                            ...
                            <div class="card">
                                ...
                                <div class="card-body add-post">
                                    <form class="row needs-validation" novalidate="" id="formPost"
                                        action="{{ route('sponsor.update', $sponsor->id) }}" method="POST"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="title" name="title"
                                                    type="text" placeholder="Sponsor Title"
                                                    value="{{ $sponsor->title }}" required="">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="content" name="content" cols="10" rows="2" class="form-control" required="">{{ $sponsor->content }}</textarea>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div id="imagePreview" class="mt-3"
                                                style="{{ $sponsor->image ? '' : 'display: none;' }}">
                                                <img id="previewImg" src="{{ asset('storage/' . $sponsor->image) }}"
                                        ...
                                        <div class="btn-showcase text-end">
                                            ...
                                            <a href="{{ route('sponsor') }}" class="btn btn-light">Cancel</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
