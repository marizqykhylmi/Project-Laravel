...
<!-- Mirrored from admin.pixelstrap.net/crocs/template/{{ route ('user-profile') }} by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 06:44:04 GMT -->
<head>
              ...
              <li class="onhover-dropdown">
                ...
                <div class="onhover-show-div notification-dropdown">
                  ...
                  <div class="d-flex align-items-center"><img src="../assets/images/dashboard/user/6.png" alt="">
                    <div class="flex-grow-1 ms-2"><a href="{{ route ('user-profile') }}">
                        <h5>
                           Stephen Curry <strong> Completed </strong> Create new component</h5><span>2.15pm</span></a></div>
                    <div class="flex-shrink-0"> 
                  ...
                  <div class="d-flex align-items-center figma-line"><img src="../assets/images/dashboard/user/7.png" alt="">
                    <div class="flex-grow-1 ms-2"><a href="{{ route ('user-profile') }}">
                        <h5>Stephen Curry mentioned you in rewrite button component</h5><span>3.10pm</span></a></div>
                  </div>
                </div>
              </li>
              <li class="onhover-dropdown">
                      ...
                      <div class="like-comment">
                        <ul class="list-inline">
                          <li class="list-inline-item border-right pe-3">
                            <label class="m-0"><a href="#" onclick="event.preventDefault();"><i class="fa fa-heart"></i></a>  Like</label><span class="ms-2 counter">2659</span>
                          </li>
...
<!-- Mirrored from admin.pixelstrap.net/crocs/template/{{ route ('user-profile') }} by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 06:44:08 GMT -->
</html>