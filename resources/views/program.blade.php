                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            <div class="notification-box">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/crocs/assets/svg/icon-sprite.svg#fill-Bell">
                                    </use>
                            ...
                            <div class="onhover-show-div notification-dropdown">
                                ...
                                <div class="d-flex align-items-center"><img
                                    ...
                                    <div class="flex-grow-1 ms-2"><a href="{{ route('user-profile') }}">
                                            <h5>
                                                Ralph Edwards <strong> wants to edit </strong> tetrisly design system
                                            </h5><span>2hrs Ago</span>
                                        </a></div>
                                            ...
                                            <div class="col-xxl-6 col-lg-6 col-md-12">
                                                <div class="card shadow-sm border-0">
                                                    <div class="row g-0 align-items-center">
                                                        <!-- Image Section -->
                                                        <div class="col-sm-5">
                                                            <img class="img-fluid w-100 rounded-start"
                                                                src="{{ asset('storage/images/' . $program->image) }}"
                                                                alt="{{ $program->title }}"
                                                        ...
                                                        <div class="col-sm-7 p-3">
                                                            <div class="blog-details">
                                                                <div class="blog-date text-muted small">
                                                                    <span class="fw-bold">
                                                                        {{ \Carbon\Carbon::parse($program->publish_date)->format('d') }}
                                                                    </span>
                                                                    {{ \Carbon\Carbon::parse($program->publish_date)->format('F Y') }}
                                                                </div>
                                                                ...
                                                                <div class="d-flex gap-2">
                                                                    ...
                                                                    <!-- Button Delete -->
                                                                    <form
                                                                        action="{{ route('program.delete', $program->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
